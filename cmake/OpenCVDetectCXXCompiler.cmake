...
if(MINGW64 OR (MSVC64 AND NOT CMAKE_CROSSCOMPILING))
  set(X86_64 1)
...
elseif(MSVC)
  if((CMAKE_GENERATOR MATCHES "ARM64") OR (CMAKE_GENERATOR_PLATFORM STREQUAL "ARM64") OR ("${arch_hint}" STREQUAL "ARM64") OR (CMAKE_VS_EFFECTIVE_PLATFORMS MATCHES "ARM64|arm64"))
    # see Modules/CmakeGenericSystem.cmake
    set(OpenCV_ARCH ARM64)
  elseif((CMAKE_GENERATOR MATCHES "ARM") OR (CMAKE_GENERATOR_PLATFORM STREQUAL "ARM") OR ("${arch_hint}" STREQUAL "ARM") OR (CMAKE_VS_EFFECTIVE_PLATFORMS MATCHES "ARM|arm"))
    # see Modules/CmakeGenericSystem.cmake
    set(OpenCV_ARCH ARM)
  elseif(CMAKE_CL_64)
    set(OpenCV_ARCH x64)
